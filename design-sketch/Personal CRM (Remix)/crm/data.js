window.SOURCE_CONFIG = {
  bluesky:  { label: 'Bluesky',  color: 'oklch(62% 0.15 232)', bg: 'oklch(95% 0.04 232)' },
  email:    { label: 'Email',    color: 'oklch(60% 0.14 28)',  bg: 'oklch(95% 0.04 28)'  },
  telegram: { label: 'Telegram', color: 'oklch(58% 0.15 245)', bg: 'oklch(95% 0.04 245)' },
  signal:   { label: 'Signal',   color: 'oklch(58% 0.14 155)', bg: 'oklch(95% 0.04 155)' },
  notes:    { label: 'Notes',    color: 'oklch(60% 0.11 82)',  bg: 'oklch(95% 0.04 82)'  },
};
